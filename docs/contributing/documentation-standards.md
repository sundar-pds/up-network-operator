...
- "AMD Network Operator" (not "Network operator" or "network-operator")
...
| Term | Usage Notes |
|------|-------------|
| AMD Network driver | Standard term for the driver. Don't use "AMDNetwork driver" or "Network driver" alone |
...
```bash
helm install amd-network-operator rocm/network-operator-helm
```
...
|-----------|-------------|---------|
| `image` | Container image path | `rocm/network-operator:latest` |
